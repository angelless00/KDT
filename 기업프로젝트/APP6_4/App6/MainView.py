...
class MainView(QMainWindow, form_class):
    ...
    def update_log_list(self, combined_message):
        ...
        message, case = combined_message.rsplit('|', 1)  # 문자열을 나누어 message와 reck 추출
        # showlist 호출
    ...
    def showlist(self,s):
        ...
        if len(log_df)>0:
            ...
            elif self.search_case=='case reck':
                log_df=log_df[log_df['case']=='case_reck']
